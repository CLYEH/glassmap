/**
 * The human's four gestures, announced where they happen.
 *
 ...
 * claim it was — so the four human effects are told directly by the four
 * places a person can act: finishing a hand-drawn polygon and landing a
 * hand-planned walk (both `draw-store.ts`), submitting the note form by hand
 * (`AddNoteForm.tsx`) and pressing ✕ in the inspector (`Inspector.tsx`).
 *
